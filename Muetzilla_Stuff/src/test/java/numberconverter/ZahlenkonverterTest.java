...
class ZahlenkonverterTest {
    ...
    public void TestHex7(){
        Zahlenkonverter zk = new Zahlenkonverter();
        assertEquals(Integer.toHexString(7), zk.convertDezToHex(7).toLowerCase());
    }
    @Test
    public void TestHex21(){
        Zahlenkonverter zk = new Zahlenkonverter();
        assertEquals(Integer.toHexString(21), zk.convertDezToHex(21).toLowerCase());
    }
    @Test
    public void TestHex174(){
        Zahlenkonverter zk = new Zahlenkonverter();
        assertEquals(Integer.toHexString(174), zk.convertDezToHex(174).toLowerCase());
    }
    @Test
    public void TestToAnyOctal(){
        Zahlenkonverter zk = new Zahlenkonverter();
        assertEquals(Integer.toOctalString(16), zk.convertDezToAny(16, 8).toLowerCase());
    }
    @Test
    public void TestToAny21erSystem(){
        Zahlenkonverter zk = new Zahlenkonverter();
        assertEquals("g42i", zk.convertDezToAny(150000, 21).toLowerCase());
    }
}